Name "Aeru Core ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/aeru/core-geth/issues"
!define UPDATEURL "https://github.com/aeru/core-geth/releases"
!define ABOUTURL "https://github.com/aeru/core-geth"
...
# Install aeru binary
Section "Aeru Core" AERU_IDX
  SetOutPath $INSTDIR
  file {{.Geth}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\aeru.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\aeru.exe" "attach"
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Aeru incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\aeru.exe" "" "" "Aeru" 30303 "" "" ""
  SimpleFC::AdvAddRule "Aeru outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\aeru.exe" "" "" "Aeru" "" 30303 "" ""
  SimpleFC::AdvAddRule "Aeru UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\aeru.exe" "" "" "Aeru" "" 30303 "" ""

  # Set default IPC endpoint
  ${EnvVarUpdate} $0 "AERU_SOCKET" "R" "HKLM" "\\.\pipe\aeru.ipc"
  ${EnvVarUpdate} $0 "AERU_SOCKET" "A" "HKLM" "\\.\pipe\aeru.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${AERU_IDX}
    SectionGetSize ${AERU_IDX} $0
